...
export default function PrayerPage() {
  ...
  return (
    ...
    >
      ...
      <section className="relative bg-[#070F1E] border-b border-stone-800 py-12 sm:py-16 text-left overflow-hidden">
        <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-3">
            <span className="text-xs sm:text-sm font-bold uppercase tracking-wider text-blue-300 bg-blue-950 px-3.5 py-1 rounded-md border border-blue-500 inline-flex items-center shadow-xs">
      ...
      {/* Main Prayer Form Grid with Subtle Background */}
      <section className="relative py-14 min-h-[600px] text-left overflow-hidden bg-[#070D18]">
        ...
        <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            {/* Prayer Form (7 cols) - SOLID OPAQUE CARD */}
            <motion.div
              ...
              <div className="bg-[#111726] border-2 border-stone-700 p-6 sm:p-8 rounded-3xl shadow-xl space-y-4 text-white">
                ...
                <div className="pt-2 space-y-2 text-sm font-bold">
                  <a
                    ...
                    className="flex items-center justify-between p-3 bg-stone-900 border border-stone-700 rounded-xl hover:bg-stone-800 transition"
                  >
                    <span className="text-stone-200">ആശ്രമം ഓഫീസ്:</span>
                    <span className="text-amber-400 font-extrabold">04822 238335</span>
                  </a>
                  <a
                    href="tel:8590124063"
                    className="flex items-center justify-between p-3 bg-stone-900 border border-stone-700 rounded-xl hover:bg-stone-800 transition"
                  >
                    <span className="text-stone-200">ഹെൽപ്പ്‌ലൈൻ:</span>
                    <span className="text-amber-400 font-extrabold">+91 8590124063</span>
                  </a>
                  <a

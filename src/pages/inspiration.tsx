...
export default function InspirationPage() {
  return (
    ...
    >
      ...
      {/* Main Founders Bio Grid with Cloister Background */}
        ...
        <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="bg-stone-900/85 backdrop-blur-md border border-white/15 p-6 sm:p-8 rounded-3xl shadow-xl space-y-6 text-white text-left"
            >
              ...
              <div className="space-y-3 text-xs sm:text-sm text-stone-200 leading-relaxed font-normal border-t border-white/10 pt-4">
                <p>
